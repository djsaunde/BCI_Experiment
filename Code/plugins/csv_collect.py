...
class PluginCSVCollect(plugintypes.IPluginExtended):
	...
	def activate(self):
		...
		with open(self.file_name, 'a') as f:
			f.write('%'+self.time_stamp + self.delim + 'Packet ID' + self.delim + 'EEG 1' + self.delim + 'EEG 2' + self.delim + 'EEG 3' + self.delim + 'EEG 4' + self.delim + 'EEG 5' + self.delim + 'EEG 6' + self.delim + 'EEG 7' + self.delim + 'EEG 8' + self.delim + 'AUX 1' + self.delim + 'AUX 2' + self.delim + 'AUX 3' + self.delim + '\n')
